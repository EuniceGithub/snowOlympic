	...
	function Swiper(obj) {
		...
		if ((navigator.userAgent.match(/(phone|pad|pod|iPhone|iPod|ios|iPad|Android|Mobile|BlackBerry|IEMobile|MQQBrowser|JUC|Fennec|wOSBrowser|BrowserNG|WebOS|Symbian|Windows Phone)/i))) {
		   this.containerWidth = document.body.clientWidth; // 轮播图盒子宽度
			...
			// PC端
		   this.containerWidth = 80; // 轮播图盒子宽度
		}
	...
	Swiper.prototype = {
		init: function() {
			...
			if (this.imgArr.length >2) {
				resImgArr = [this.imgArr[this.imgArr.length-3],this.imgArr[this.imgArr.length-2], this.imgArr[this.imgArr.length-1], ...this.imgArr, this.imgArr[0], this.imgArr[1] ,this.imgArr[2] ];
